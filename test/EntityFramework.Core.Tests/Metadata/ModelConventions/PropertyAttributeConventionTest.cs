...
namespace Microsoft.Data.Entity.Metadata.Conventions
{
    public class PropertyAttributeConventionTest
    {
        ...
        public void NotMappedAttribute_overrides_configuration_from_convention_source()
        {
            ...
            Assert.NotNull(entityBuilder.Property(typeof(string), "IgnoredProperty", ConfigurationSource.Convention));

            new NotMappedAttributeConvention().Apply(entityBuilder.Property(typeof(string), "IgnoredProperty", ConfigurationSource.Convention));

            Assert.Null(entityBuilder.Property(typeof(string), "IgnoredProperty", ConfigurationSource.Convention));
        }
        ...
        public void NotMappedAttribute_does_not_override_configuration_from_explicit_source()
        {
            ...
            new NotMappedAttributeConvention().Apply(entityBuilder.Property(typeof(string), "IgnoredProperty", ConfigurationSource.Explicit));
