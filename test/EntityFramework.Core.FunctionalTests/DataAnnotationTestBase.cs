...
namespace Microsoft.Data.Entity.FunctionalTests
{
        ...
        where TFixture : DataAnnotationFixtureBase<TTestStore>, new()
    {
        ...
        [Fact]
        public virtual void NotMappedAttribute_ignores_the_property()
        {
            using (var context = CreateContext())
            {
                context.Ones.Add(new One { RequiredColumn = "Fourth", RowVersion = new Guid("00000000-0000-0000-0000-000000000004"), IgnoredProperty = "UselessValue" });
